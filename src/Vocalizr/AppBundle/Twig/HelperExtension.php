...
class HelperExtension extends \Twig_Extension
{
    ...
    {
        return [
            'timeAgoString'              => new \Twig_Filter_Method($this, 'timeAgoFilter'),
            'timeLeftString'             => new \Twig_Filter_Method($this, 'timeLeftFilter'),
            'timeLeftSingle'             => new \Twig_Filter_Method($this, 'timeLeftSingle'),
            'daysOffset'                 => new \Twig_Filter_method($this, 'daysOffsetFilter'),
            'starRating'                 => new \Twig_Filter_Method($this, 'starRatingFilter'),
            'unserialize'                => new \Twig_Filter_Method($this, 'unserializeFilter'),
            'jsonDecode'                 => new \Twig_Filter_Method($this, 'jsonDecodeFilter'),
            'jsonEncode'                 => new \Twig_Filter_Method($this, 'jsonEncodeFilter'),
            'addPricePercent'            => new \Twig_Filter_Method($this, 'addPricePercentFilter'),
            'getPricePercent'            => new \Twig_Filter_Method($this, 'getPricePercentFilter'),
            'json_decode'                => new \Twig_Filter_Method($this, 'jsonDecodeFilter'),
            'parseWalletDesc'            => new \Twig_Filter_Method($this, 'parseWalletDescFilter'),
            'assetExists'                => new \Twig_Filter_Method($this, 'assetExists'),
            'projectAssetExists'         => new \Twig_Filter_Method($this, 'projectAssetExists'),
            'marketplaceItemAssetExists' => new \Twig_Filter_Method($this, 'marketplaceItemAssetExists'),
            'countryName'                => new \Twig_Filter_Method($this, 'countryNameFilter'),
            'formatBytes'                => new \Twig_Filter_Method($this, 'formatBytes'),
            'array_filter'               => new \Twig_SimpleFilter('array_filter', 'array_filter')
        ];
    }
    ...
    public function parseWalletDescFilter($str, $data, $type = null)
    {
        ...
        if (stristr($str, '{project}') && isset($data->projectUuid)) {
            ...
            if (isset($data->projectType) && $data->projectType == 'contest') {
                ...
                $project = $em->getRepository('VocalizrAppBundle:Project')->getProjectByUuid($data->projectUuid);
