...
use Vocalizr\AppBundle\Entity\UserVideo;
...
class ProProfileController extends Controller
{
    ...
    public function indexAction(UserInfo $profileUser)
    {
        ...
        $userReviews = $paginator->paginate(
            $em->getRepository('VocalizrAppBundle:UserReview')->getUserReviewsQb($profileUser),
            1,
            50
        );
        ...
        $topConnections = $paginator->paginate(
            $em->getRepository('VocalizrAppBundle:UserConnect')
