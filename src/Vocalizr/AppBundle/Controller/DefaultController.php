...
class DefaultController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $user = new \Vocalizr\AppBundle\Entity\UserInfo();
    ...
    {
        $view = $request->get('_view', 'VocalizrAppBundle:Default:error.html.twig');
    ...
    public function confirmEmailAction()
    {
        ...
        if (!$result = $em->getRepository('VocalizrAppBundle:EmailChangeRequest')->findOneBy(['unique_key' => $request->get('key')])) {
    ...
    {
        return $this->forward('VocalizrAppBundle:Default:index');
    }
    ...
    public function loginAsAction(Request $request)
    {
        ...
        $user = $em->getRepository('VocalizrAppBundle:UserInfo')->find($id);
    ...
    {
        $this->container->get('vocalizr_app.service.membership_source_helper')->handleRequest(
            $request,
            MembershipSourceObject::STATUS_MEMBERSHIP_PAGE
        );

        return $this->render('@VocalizrApp/Default/membership.html.twig');
    }
    ...
    public function singersAction(Request $request)
    {
        ...
        $form = $this->createForm(new \Vocalizr\AppBundle\Form\Type\UserSearchType($projectYml['budget']));
    ...
    public function singingJobsAction(Request $request)
    {
        ...
        $form = $this->createForm(new \Vocalizr\AppBundle\Form\Type\ProjectSearchType($projectYml['budget']));
    ...
    public function appMessageAction()
    {
        ...
        $em      = $this->getDoctrine()->getManager();
        $message = $em->getRepository('VocalizrAppBundle:AppMessage')
                ->findOneToShow($user);
        ...
        $em          = $this->getDoctrine()->getManager();
        $messageRead = $em->getRepository('VocalizrAppBundle:AppMessageRead')
                ->findOneBy(['user_info' => $user,
                    'app_message'        => $message, ]);
        if (!$messageRead) {
            $messageRead = new \Vocalizr\AppBundle\Entity\AppMessageRead();
    ...
    public function appMessageReadAction(Request $request, $id)
    {
        ...
        $data = ['success' => true,
            'newMessage'   => $this->renderView(
                'VocalizrAppBundle:Default:appMessage.html.twig',
                ['message' => $message]
            ), ];
    ...
    public function notificationsAction()
    {
        ...
        //$notifications = $em->getRepository('VocalizrAppBundle:Notification')
    ...
    public function notificationsReadAction()
    {
        ...
        $notificationRepo = $this->getDoctrine()->getRepository('VocalizrAppBundle:Notification');
