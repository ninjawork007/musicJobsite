...
class SoundcloudController extends Controller
{
    ...
    public function fetchTracksAction()
    {
        ...
        $user            = $this->getUser();
        $em              = $this->getDoctrine()->getManager();
        $userScTrackRepo = $em->getRepository('VocalizrAppBundle:UserScTrack');
    ...
    public function displayTracksAction()
    {
        ...
        $scTracks = false;
        if ($user) {
            $scTracks = $em->getRepository('VocalizrAppBundle:UserScTrack')->getTracksByUserInfoId($user->getId());
        }
