...
class PaypalController extends Controller
{
     ...
     */
    public function proSuccessAction(Request $request)
    {
        ...
        return $this->render('@VocalizrApp/Paypal/proSuccess.html.twig', [
            'user'  => $user,
            'track' => $track,
        ]);
    }
    ...
    public function promoAction(Request $request)
    {
        ...
        if ($request->get('plan') && $this->getUser()) {
            return $this->render('VocalizrAppBundle:Paypal:promoRedirect.html.twig');
        }
