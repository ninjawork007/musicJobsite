...
class UserConnectModel extends Model
{
    ...
    public function validateConnectionAttempt(UserInfo $fromUser, UserInfo $toUser)
    {
        ...
        if ($this->em->getRepository('VocalizrAppBundle:UserBlock')->findOneBy([
            'user_info'  => $toUser,
            'block_user' => $fromUser,
        ])) {
    ...
    {
        return 'VocalizrAppBundle:UserConnect';
    }
    ...
    {
        return $this->em->getRepository('VocalizrAppBundle:UserConnectInvite');
    }
