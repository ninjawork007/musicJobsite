...
use Vocalizr\AppBundle\Entity\UserVocalCharacteristic;
use Vocalizr\AppBundle\Entity\UserVocalStyle;
...
use Vocalizr\AppBundle\Repository\UserVocalCharacteristicRepository;
use Vocalizr\AppBundle\Repository\UserVocalStyleRepository;
use Vocalizr\AppBundle\Repository\UserVoiceTagRepository;
...
class UserInfoModel extends Model
{
    ...
    public function getTags(UserInfo $toUser, UserInfo $fromUser = null)
    {
        ...
        $entityAliases = [
            'voiceTags'            => 'VocalizrAppBundle:UserVoiceTag',
            'vocalStyles'          => 'VocalizrAppBundle:UserVocalStyle',
            'vocalCharacteristics' => 'VocalizrAppBundle:UserVocalCharacteristic',
        ];
    ...
    public function deactivate(UserInfo $userInfo)
    {
        ...
        $this->em->getRepository('VocalizrAppBundle:VocalizrActivity')->deleteUserActivity($userInfo);
        ...
        $projectBidRepository = $this->em->getRepository('VocalizrAppBundle:ProjectBid');
    ...
    {
        return $this->em->getRepository('VocalizrAppBundle:UserReview')->getUserReviewsCount($user);
    }
    ...
    {
        return $this->em->getRepository('VocalizrAppBundle:UserBlock')
    ...
    private function generateThumbnail($inputFile, $outputFile, $size, $parameters = [])
    {
        ...
        try {
            ...
            $image->square_crop($size);
            $image->save($outputFile, $quality);
    ...
    {
        return 'VocalizrAppBundle:UserInfo';
    }
}