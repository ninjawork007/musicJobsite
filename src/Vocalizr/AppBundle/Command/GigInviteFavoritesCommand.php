 ...
 * Setup the platform
 */
class GigInviteFavoritesCommand extends ContainerAwareCommand
{
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $project = $em->getRepository('VocalizrAppBundle:Project')->find($projectId);
        if (!$project) {
        ...
        $userInfoFavs = $em->getRepository('VocalizrAppBundle:UserInfo')->getUserFavoritesForInviting($userId, $project);
