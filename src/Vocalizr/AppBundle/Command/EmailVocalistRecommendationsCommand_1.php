...
class EmailVocalistRecommendationsCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $q = $this->em->getRepository('VocalizrAppBundle:Project')
                ...
                ->setParameter('publishType', \Vocalizr\AppBundle\Entity\Project::PUBLISH_PUBLIC)
                ->setParameter('projectType', \Vocalizr\AppBundle\Entity\Project::PROJECT_TYPE_PAID)
