 ...
 */
class FixUserWalletTransactionsCommand extends ContainerAwareCommand
{
    /**
     * @var EntityManager
     */
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $userRepo = $this->em->getRepository('VocalizrAppBundle:UserInfo');
    ...
    private function fixTransactionsForUser(UserInfo $user)
    {
        ...
        $reverseTransactions = $this->em->getRepository('VocalizrAppBundle:UserWalletTransaction')
    ...
    {
        $qb = $this->em->getRepository('VocalizrAppBundle:UserWithdraw')->createQueryBuilder('uw');
        $qb
