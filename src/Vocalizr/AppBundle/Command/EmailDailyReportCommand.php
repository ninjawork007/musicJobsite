...
use Vocalizr\AppBundle\Repository\UserCertificationRepository;
 ...
 */
class EmailDailyReportCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $q = $this->em->getRepository('VocalizrAppBundle:UserConnect')
        ...
        $numCancelledSubsByUser = $this->em->getRepository('VocalizrAppBundle:UserSubscription')
        ...
        $numCancelledSubsByStripe = $this->em->getRepository('VocalizrAppBundle:UserSubscription')
        ...
        $q = $this->em->getRepository('VocalizrAppBundle:UserConnectInvite')
        ...
        $q = $this->em->getRepository('VocalizrAppBundle:UserWalletTransaction')
        ...
        $q = $this->em->getRepository('VocalizrAppBundle:ProjectBid')->createQueryBuilder('pb')
            ->select('count(pb.id)')
        ...
        $q = $this->em->getRepository('VocalizrAppBundle:Project')->createQueryBuilder('p')
            ->select('count(p.id)')
        ...
        $q = $this->em->getRepository('VocalizrAppBundle:UserInfo')->createQueryBuilder('u')
            ->select('count(u.id)')
        ...
        $q = $this->em->getRepository('VocalizrAppBundle:MessageThread')->createQueryBuilder('mt')
            ->select('count(mt.id)')
        ...
        $certificationsRepository = $this->em->getRepository('VocalizrAppBundle:UserCertification');
