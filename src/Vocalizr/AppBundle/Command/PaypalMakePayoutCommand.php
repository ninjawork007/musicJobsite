...
use Vocalizr\AppBundle\Repository\UserWithdrawRepository;
 ...
 */
class PaypalMakePayoutCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $withdrawRepo = $this->em->getRepository('VocalizrAppBundle:UserWithdraw');
