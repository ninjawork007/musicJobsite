...
class ScAudioCheckCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $q = $em->getRepository('VocalizrAppBundle:UserAudio')
        ...
        if ($results) {
            ...
            foreach ($results as $userAudio) {
                ...
                if ($notification = $em->getRepository('VocalizrAppBundle:Notification')->findOneBy(['user_audio' => $userAudio->getId()])) {
