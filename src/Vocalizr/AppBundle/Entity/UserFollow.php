...
/**
 * @ORM\Entity(repositoryClass="Vocalizr\AppBundle\Repository\UserFollowRepository")
...
class UserFollow
{
     ...
     * @return UserFollow
     */
    public function setFollowUser(\Vocalizr\AppBundle\Entity\UserInfo $followUser = null)
    {
