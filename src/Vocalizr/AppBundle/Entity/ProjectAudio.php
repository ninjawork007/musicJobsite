...
class ProjectAudio
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UserInfo", inversedBy="project_audio")
     */
    protected $user_info;

    /**
     * @ORM\ManyToOne(targetEntity="Project", inversedBy="project_audio")
     */
    protected $project;
    ...
    /**
     * @ORM\OneToMany(targetEntity="ProjectAudioDownload", mappedBy="project_audio")
     */
    protected $project_audio_downloads;
    ...
    protected function getUploadDir()
    {
        ...
        $dir = 'uploads/audio/project/' . $this->getId() . '/';
    ...
    {
        $this->project_audio_downloads = new \Doctrine\Common\Collections\ArrayCollection();
    }

    /**
     * Add project_audio_downloads
     *
     * @param \Vocalizr\AppBundle\Entity\ProjectAudioDownload $projectAudioDownloads
     *
     * @return ProjectAudio
     */
    public function addProjectAudioDownload(\Vocalizr\AppBundle\Entity\ProjectAudioDownload $projectAudioDownloads)
    {
        $this->project_audio_downloads[] = $projectAudioDownloads;

        return $this;
    }

    /**
     * Remove project_audio_downloads
     *
     * @param \Vocalizr\AppBundle\Entity\ProjectAudioDownload $projectAudioDownloads
     */
    public function removeProjectAudioDownload(\Vocalizr\AppBundle\Entity\ProjectAudioDownload $projectAudioDownloads)
    {
        $this->project_audio_downloads->removeElement($projectAudioDownloads);
    }

    /**
     * Get project_audio_downloads
     *
     * @return \Doctrine\Common\Collections\Collection
     */
    public function getProjectAudioDownloads()
    {
        return $this->project_audio_downloads;
    }
}