...
/**
 * @ORM\Entity(repositoryClass="Vocalizr\AppBundle\Repository\UserScTrackRepository")
...
class UserScTrack
{
     ...
     * @return UserScTrack
     */
    public function addUserAudio(\Vocalizr\AppBundle\Entity\UserAudio $userAudio)
    {
     ...
     * @param \Vocalizr\AppBundle\Entity\UserAudio $userAudio
     */
    public function removeUserAudio(\Vocalizr\AppBundle\Entity\UserAudio $userAudio)
    {
