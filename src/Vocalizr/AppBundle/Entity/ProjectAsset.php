...
/**
 * @ORM\Entity(repositoryClass="Vocalizr\AppBundle\Repository\ProjectAssetRepository")
...
class ProjectAsset
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Project", inversedBy="project_assets")
     */
    protected $project;
    ...
    protected function getUploadDir()
    {
        ...
        $dir = 'uploads/project/' . $this->project->getId() . '/assets/';
        return $dir;
    }
    ...
    /**
     * @param bool $wave_generated
     *
     * @return ProjectAsset
     */
    public function setWaveGenerated($wave_generated)
    {
        $this->wave_generated = $wave_generated;
        return $this;
    }
}