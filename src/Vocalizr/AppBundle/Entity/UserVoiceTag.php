...
/**
 * @ORM\Entity(repositoryClass="Vocalizr\AppBundle\Repository\UserVoiceTagRepository")
...
class UserVoiceTag
{
     ...
     * @return UserTag
     */
    public function setTaggedBy(\Vocalizr\AppBundle\Entity\UserInfo $taggedBy = null)
    {
     ...
     * Set voice_tag
     *
     * @param \Vocalizr\AppBundle\Entity\VoiceTag $voiceTag
     *
     * @return UserVoiceTag
     */
    public function setVoiceTag(\Vocalizr\AppBundle\Entity\VoiceTag $voiceTag = null)
    {
     ...
     * Get voice_tag
     *
     * @return \Vocalizr\AppBundle\Entity\VoiceTag
     */
     ...
     *
     * @param \Vocalizr\AppBundle\Entity\UserVoiceTagVote $userVoiceTagVotes
     *
     * @return UserVoiceTag
     */
    public function addUserVoiceTagVote(\Vocalizr\AppBundle\Entity\UserVoiceTagVote $userVoiceTagVotes)
    {
     ...
     * @param \Vocalizr\AppBundle\Entity\UserVoiceTagVote $userVoiceTagVotes
     */
    public function removeUserVoiceTagVote(\Vocalizr\AppBundle\Entity\UserVoiceTagVote $userVoiceTagVotes)
    {
