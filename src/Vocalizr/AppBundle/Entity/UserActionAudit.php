 ...
 *
 * @ORM\Entity(repositoryClass="Vocalizr\AppBundle\Repository\UserActionAuditRepository")
...
class UserActionAudit
{
     ...
     * @var UserInfo
     *
     * @ORM\ManyToOne(targetEntity="Vocalizr\AppBundle\Entity\UserInfo", inversedBy="audits")
     ...
     *
     * @ORM\ManyToOne(targetEntity="Vocalizr\AppBundle\Entity\UserWithdraw")
     * @ORM\JoinColumn(onDelete="SET NULL")
     */
    private $withdraw;
