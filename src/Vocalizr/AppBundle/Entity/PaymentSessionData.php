 ...
 *
 * @ORM\Entity(repositoryClass="Vocalizr\AppBundle\Repository\PaymentSessionDataRepository")
...
class PaymentSessionData
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Vocalizr\AppBundle\Entity\StripeCharge")
     ...
     * @var Project|null
     *
     * @ORM\ManyToOne(targetEntity="Vocalizr\AppBundle\Entity\Project")
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    private $project;
     ...
     * @var ProjectBid|null
     *
     * @ORM\ManyToOne(targetEntity="Vocalizr\AppBundle\Entity\ProjectBid")
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    private $bid;
     ...
     *
     * @ORM\ManyToOne(targetEntity="Vocalizr\AppBundle\Entity\UserCertification")
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
