...
/**
 * @ORM\Entity(repositoryClass="Vocalizr\AppBundle\Repository\ProjectBidRepository")
...
class ProjectBid
{
     ...
     * @var UserAudio|null
     *
     * @ORM\ManyToOne(targetEntity="Vocalizr\AppBundle\Entity\UserAudio")
    ...
    /**
     * @var ProjectBidLog
     * @ORM\OneToOne(targetEntity="Vocalizr\AppBundle\Entity\ProjectBidLog", mappedBy="bid", cascade={"persist", "remove"})
     */
    protected $logEntry;
