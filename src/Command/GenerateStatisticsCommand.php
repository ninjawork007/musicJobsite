...
class GenerateStatisticsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->em->getRepository('App:Statistics')
        ...
        // process daily
        $q = $this->em->getRepository('App:Statistics')
                    ->createQueryBuilder('s')
    ...
    private function processStats($label, $interval, $startDate, $today)
    {
        ...
        while ($processDate < $today) {
            ...
            $statsEntry = new \App\Entity\Statistics();
            ...
            $q = $this->em->getRepository('App:ProjectEscrow')
            ...
            $q = $this->em->getRepository('App:PayPalTransaction')
            ...
            $q = $this->em->getRepository('App:Message')
