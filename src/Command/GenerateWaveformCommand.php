...
class GenerateWaveformCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $projectAudioRepo  = $doctrine->getRepository('App:ProjectAudio');
        $projectBidRepo    = $doctrine->getRepository('App:ProjectBid');
        $projectAssetsRepo = $doctrine->getRepository('App:ProjectAsset');
