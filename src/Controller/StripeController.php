...
class StripeController extends AbstractController
{
    ...
    {
        return $this->getDoctrine()->getManager()->getRepository('App:UserInfo')->findOneBy([
    ...
    {
        $identity = $this->getDoctrine()->getManager()->getRepository('App:UserStripeIdentity')->findOneBy([
