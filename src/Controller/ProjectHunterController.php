...
class ProjectHunterController extends AbstractController
{
    /**
    ...
    public function indexAction(Request $request, ContainerInterface $container)
    {
        ...
        $form = $this->createForm(ProjectSearchType::class, $projectYml['budget']);
        ...
        $qb = $em->getRepository('App:Project')
        ...
        return $this->render('ProjectHunter/index.html.twig', [
