...
class VmagController extends AbstractController
{
    /**
    ...
    public function categoryAction($slug)
    {
        ...
        $category = $em->getRepository('App:ArticleCategory')->findOneBy(['slug' => $slug]);
    ...
    public function viewAction(Request $request)
    {
        ...
        $em      = $this->getDoctrine()->getManager();
        $article = $em->getRepository('App:Article')->findOneBy([
    ...
    public function subscribeAction(Request $request)
    {
        ...
        // Search our database
        $qb = $em->getRepository('App:MagUser')
        ...
        if (!$magUser || !isset($magUser[0])) {
            $magUser = new \App\Entity\MagUser();
        } else {
            $magUser = $magUser[0];
        }
    ...
    public function unsubscribeAction($uid)
    {
        ...
        $magUser = $em->getRepository('App:MagUser')->findOneBy(['uid' => $uid]);
        if ($magUser) {
