...
class WaveformService
{
     ...
     */
    public function __construct(EntityManagerInterface $em, MediaInfoService $mediaInfoService, ParameterBagInterface $parameterBag)
    {
        $this->em               = $em;
        $this->baseDir          = $parameterBag->get('kernel.project_dir').'/public/';
        $this->mediaInfoService = $mediaInfoService;
        $this->scClientId       = $parameterBag->get('soundcloud_client_id');
    }
