...
/**
 * @ORM\Entity(repositoryClass="App\Repository\AdminActionAuditRepository")
...
class AdminActionAudit
{
     ...
     * Set actioner
     *
     * @param \App\Entity\UserInfo $actioner
     *
     * @return AdminActionAudit
     */
    public function setActioner(\App\Entity\UserInfo $actioner = null)
    {
