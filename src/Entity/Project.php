...
use App\Validator\Constraints\CustomRegex;
...
class Project
{
     ...
     * @return Project
     */
    public function addLanguage(\App\Entity\Language $languages)
    {
     ...
     * @param \App\Entity\Language $languages
     */
    public function removeLanguage(\App\Entity\Language $languages)
    {
     ...
     *
     * @param \App\Entity\VocalCharacteristic $vocalCharacteristics
     *
     * @return Project
     */
    public function addVocalCharacteristic(\App\Entity\VocalCharacteristic $vocalCharacteristics)
    {
     ...
     * @param \App\Entity\VocalCharacteristic $vocalCharacteristics
     */
    public function removeVocalCharacteristic(\App\Entity\VocalCharacteristic $vocalCharacteristics)
    {
     ...
     * Add project_bids
     *
     * @param \App\Entity\ProjectBid $projectBids
     *
     * @return Project
     */
    public function addProjectBid(\App\Entity\ProjectBid $projectBids)
    {
     ...
     * @param \App\Entity\ProjectBid $projectBids
     */
    public function removeProjectBid(\App\Entity\ProjectBid $projectBids)
    {
     ...
     * Add vocalStyles
     *
     * @param \App\Entity\VocalStyle $vocalStyles
     *
     * @return Project
     */
    public function addVocalStyle(\App\Entity\VocalStyle $vocalStyles)
    {
     ...
     * @param \App\Entity\VocalStyle $vocalStyles
     */
    public function removeVocalStyle(\App\Entity\VocalStyle $vocalStyles)
    {
     ...
     *
     * @param \App\Entity\ProjectComment $projectComments
     *
     * @return Project
     */
    public function addProjectComment(\App\Entity\ProjectComment $projectComments)
    {
     ...
     * @param \App\Entity\ProjectComment $projectComments
     */
    public function removeProjectComment(\App\Entity\ProjectComment $projectComments)
    {
     ...
     * Add project_lyrics
     *
     * @param \App\Entity\ProjectLyrics $projectLyrics
     *
     * @return Project
     */
    public function addProjectLyric(\App\Entity\ProjectLyrics $projectLyrics)
    {
     ...
     * @param \App\Entity\ProjectLyrics $projectLyrics
     */
    public function removeProjectLyric(\App\Entity\ProjectLyrics $projectLyrics)
    {
     ...
     *
     * @param \App\Entity\UserTransaction $userTransaction
     *
     * @return Project
     */
    public function setUserTransaction(\App\Entity\UserTransaction $userTransaction = null)
    {
     ...
     * Add project_assets
     *
     * @param \App\Entity\ProjectAsset $projectAssets
     *
     * @return Project
     */
    public function addProjectAsset(\App\Entity\ProjectAsset $projectAssets)
    {
     ...
     * @param \App\Entity\ProjectAsset $projectAssets
     */
    public function removeProjectAsset(\App\Entity\ProjectAsset $projectAssets)
    {
     ...
     *
     * @param \App\Entity\ProjectContract $projectContracts
     *
     * @return Project
     */
    public function addProjectContract(\App\Entity\ProjectContract $projectContracts)
    {
     ...
     * @param \App\Entity\ProjectContract $projectContracts
     */
    public function removeProjectContract(\App\Entity\ProjectContract $projectContracts)
    {
     ...
     * Add project_invites
     *
     * @param \App\Entity\ProjectInvite $projectInvites
     *
     * @return Project
     */
    public function addProjectInvite(\App\Entity\ProjectInvite $projectInvites)
    {
     ...
     * @param \App\Entity\ProjectInvite $projectInvites
     */
    public function removeProjectInvite(\App\Entity\ProjectInvite $projectInvites)
    {
     ...
     *
     * @param \App\Entity\UserInfo $employeeUserInfo
     *
     * @return Project
     */
    public function setEmployeeUserInfo(\App\Entity\UserInfo $employeeUserInfo = null)
    {
     ...
     * @return Project
     */
    public function addProjectAudio(\App\Entity\ProjectAudio $projectAudio)
    {
     ...
     * @param \App\Entity\ProjectAudio $projectAudio
     */
    public function removeProjectAudio(\App\Entity\ProjectAudio $projectAudio)
    {
     ...
     * Add user_reviews
     *
     * @param \App\Entity\UserReview $userReviews
     *
     * @return Project
     */
    public function addUserReview(\App\Entity\UserReview $userReviews)
    {
     ...
     * @param \App\Entity\UserReview $userReviews
     */
    public function removeUserReview(\App\Entity\UserReview $userReviews)
    {
     ...
     * Add bid_messages
     *
     * @param \App\Entity\Message $bidMessages
     *
     * @return Project
     */
    public function addBidMessage(\App\Entity\Message $bidMessages)
    {
     ...
     * @param \App\Entity\Message $bidMessages
     */
    public function removeBidMessage(\App\Entity\Message $bidMessages)
    {
     ...
     * Add message_threads
     *
     * @param \App\Entity\MessageThread $messageThreads
     *
     * @return Project
     */
    public function addMessageThread(\App\Entity\MessageThread $messageThreads)
    {
     ...
     * @param \App\Entity\MessageThread $messageThreads
     */
    public function removeMessageThread(\App\Entity\MessageThread $messageThreads)
    {
     ...
     * Set hire_user
     *
     * @param \App\Entity\UserInfo $hireUser
     *
     * @return Project
     */
    public function setHireUser(\App\Entity\UserInfo $hireUser = null)
    {
