...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UserAudioRepository")
 * @ORM\HasLifecycleCallbacks()
 * @ORM\Table(name="user_audio")
 */
class UserAudio
{
    const ALBUM_ARTS_WEB_DIRECTORY = '/public/uploads/album_art';
    ...
    protected function getUploadDir()
    {
        ...
        $dir = 'public/uploads/audio/user/' . $this->user_info->getId() . '/';
     ...
     * Set sc_user_track
     *
     * @param \App\Entity\UserAudio $scUserTrack
     *
     * @return UserAudio
     */
    public function setScUserTrack(\App\Entity\UserAudio $scUserTrack = null)
    {
     ...
     * Add notifications
     *
     * @param \App\Entity\Notification $notifications
     *
     * @return UserAudio
     */
    public function addNotification(\App\Entity\Notification $notifications)
    {
     ...
     * @param \App\Entity\Notification $notifications
     */
    public function removeNotification(\App\Entity\Notification $notifications)
    {
