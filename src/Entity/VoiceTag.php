...
/**
 * @ORM\Entity(repositoryClass="App\Repository\VoiceTagRepository")
...
class VoiceTag
{
     ...
     * Add user_voice_tags
     *
     * @param \App\Entity\UserVoiceTag $userVoiceTags
     *
     * @return VoiceTag
     */
    public function addUserVoiceTag(\App\Entity\UserVoiceTag $userVoiceTags)
    {
     ...
     * @param \App\Entity\UserVoiceTag $userVoiceTags
     */
    public function removeUserVoiceTag(\App\Entity\UserVoiceTag $userVoiceTags)
    {
