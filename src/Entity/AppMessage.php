...
/**
 * @ORM\Entity(repositoryClass="App\Repository\AppMessageRepository")
...
class AppMessage
{
     ...
     * Add read_by
     *
     * @param \App\Entity\AppMessageRead $readBy
     *
     * @return AppMessage
     */
    public function addReadBy(\App\Entity\AppMessageRead $readBy)
    {
        $this->read_by[] = $readBy;
     ...
     * @param \App\Entity\AppMessageRead $readBy
     */
    public function removeReadBy(\App\Entity\AppMessageRead $readBy)
    {
