 ...
 * })
 */
class UserInfo implements UserInterface, EquatableInterface, \Serializable
{
    /**
     * @ORM\Id
     ...
     *
     * @ORM\OneToOne(
     *     targetEntity="App\Entity\UserProProfile",
     *     mappedBy="userInfo",
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\UserWithdraw", mappedBy="user_info")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\UserActionAudit", mappedBy="user")
     */
    protected $audits;
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\HintSkip", mappedBy="user", cascade={"remove"})
     */
     ...
     *
     * @ORM\OneToOne(targetEntity="App\Entity\UserTotalOnline", inversedBy="user")
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\UserStripeIdentity", mappedBy="user")
     */
     ...
     * Add audits
     *
     * @param \App\Entity\UserActionAudit $audits
     *
     * @return UserInfo
     */
    public function addAudit(\App\Entity\UserActionAudit $audits)
    {
        $this->audits[] = $audits;
     ...
     * @param \App\Entity\UserActionAudit $audits
     */
    public function removeAudit(\App\Entity\UserActionAudit $audits)
    {
